...
milestones_to_test = [[32, 64], [200, 400], [1000, 2000]] #learning rates to test
lr_decay_to_test = [0.9, 0.8, 0.7]
"""
...
"""
for milestone in milestones_to_test:
    for lr_decay in lr_decay_to_test:
        data['optim']['lr_schedule']['milestones'] = milestone
        data['optim']['lr_schedule']['lr_decay'] = lr_decay
