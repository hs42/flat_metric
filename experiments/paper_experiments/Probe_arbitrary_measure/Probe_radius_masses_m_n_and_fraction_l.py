...
for m_i, m in enumerate(m_to_test):
    for n_i, n in enumerate(n_to_test):
        for l_i, l_f in enumerate(l_fractions_to_test):
            ...
            data_generator = sum_of_Diracs.Sum_of_Diracs_with_different_radii(mock_paras, n)
            ...
            #It is important to first generate the data and then compute the ground truth. This is because the gt depends on the specific data points generated
            #It took some debugging to figure out what was going on ....
