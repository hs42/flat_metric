...
'''
dim = 2
sample_size = 10 * 2**dim #account for need for more training data in higher dimensions
...
radii_to_test = [0.1, 0.5, 1.0, 1.5] + list(range(2,47,5)) #list concatenation
...
data['distrib1']['test_sample_size'] = sample_size
data['distrib1']['test_sample_size'] = sample_size
